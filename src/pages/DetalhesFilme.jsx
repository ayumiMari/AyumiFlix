...
<br />
        ...
        <img className="max-w-md mx-10 flex flex-row-start " src={`https://image.tmdb.org/t/p/w1280/${filme.backdrop_path}`}/>
         <p className="font-bold text-2xl mx-10 flex flex-row-start">{filme.title}</p>
         <Rating className="mx-10 flex flex-row-start" value={4} />
         <p className="mx-10 flex flex-row-start">{filme.vote_average}</p>
        </div>
